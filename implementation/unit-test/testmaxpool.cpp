...
TEST_F(TestMaxPool, OneImageWithLeftoverCols) {
    //one layer
    const uint32_t input_dims[] = {1,1,4,4};
    tensor_in = tinytensor_create_new_tensor(input_dims);
    
    const uint32_t pool_dims[] = {2,3};
    const uint32_t output_dims[] = {1,1,2,2};
...
TEST_F(TestMaxPool, OneImageWithLeftoverRows) {
    //one layer
    const uint32_t input_dims[] = {1,1,4,4};
    tensor_in = tinytensor_create_new_tensor(input_dims);
    
    const uint32_t pool_dims[] = {3,2};
    const uint32_t output_dims[] = {1,1,2,2};
...
TEST_F(TestMaxPool, OneImageWithLeftoverRowsAndCols) {
    //one layer
    const uint32_t input_dims[] = {1,1,4,4};
    tensor_in = tinytensor_create_new_tensor(input_dims);
    
    const uint32_t pool_dims[] = {3,3};
    const uint32_t output_dims[] = {1,1,2,2};
    ...
    const Weight_t ref[] = {10,11,14,15};
