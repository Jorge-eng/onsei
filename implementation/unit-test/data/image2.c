...
const static ConstTensor_t image2 = {&image2_weights[0],&image2_dims[0]};
...
const static ConstTensor_t image2m = {&image2m_weights[0],&image2m_dims[0]};
const static ConstTensor_t image2m2 = {&image2m2_weights[0],&image2m_dims[0]};
